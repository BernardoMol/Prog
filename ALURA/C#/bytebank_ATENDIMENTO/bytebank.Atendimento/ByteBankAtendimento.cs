    ...
    internal  class ByteBankAtendimento
    {
        ...
        private void ExportarContas()
        {
            ...
            else
            {
                ...
                try
                {
                    FileStream fs = new FileStream(@"C:\Users\Mol\Documents\GitHub\Prog\ALURA\C#\bytebank_ATENDIMENTO\contas.json", 
                        FileMode.Create);
                    using (StreamWriter streamwriter = new StreamWriter(fs))
                    {
                        streamwriter.WriteLine(json);
                    }
                    Console.WriteLine(@"C:\Users\Mol\Documents\GitHub\Prog\ALURA\C#\bytebank_ATENDIMENTO\contas.json");
                    Console.ReadKey();
                }
                catch (Exception excecao)
                {
