...
namespace CursoWindowsForms
{
    public partial class Frm_Mascara : Form
    {
        ...
        {
            Msk_TextBox.UseSystemPasswordChar = false; // usa simbolo do sistema para password
            Lbl_Conteudo.Text = "";
        ...
        {
            Msk_TextBox.UseSystemPasswordChar = true; // usa simbolo do sistema para password
            Lbl_Conteudo.Text = "";
