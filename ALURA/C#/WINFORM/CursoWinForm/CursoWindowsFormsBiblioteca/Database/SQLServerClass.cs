...
using System.Configuration; // bilblioteca que acessa o banco
...
namespace CursoWindowsFormsBiblioteca.Database
{
    public class SQLServerClass
    {
        ...
        public SQLServerClass()
        {
            try
            {
                //stringConn = "Data Source=DESKTOP-TORSD92;Initial Catalog=ByteBank;Persist Security Info=True;User ID=sa;Password=curso;TrustServerCertificate=True";
                stringConn = ConfigurationManager.ConnectionStrings["ByteBankConnectionString"].ConnectionString;
