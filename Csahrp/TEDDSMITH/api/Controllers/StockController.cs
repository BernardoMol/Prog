...
namespace api.Controllers
{
    ...
    public class StockController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize] // MUITO FODAAAAAAAA --> AULA 24
        public async Task<IActionResult> GetALL([FromQuery] QueryObject query){
            ...
            var stockDto = stocks.Select(s => s.ToStockDto()).ToList(); // NO CARA QUE ERROU MESMO, ELE SO CORRIGE NO ULTIMO VIDEO (ele tb adiciona o tolist no ultimo video apenas)
            return Ok(stockDto);
        }
